...
class Ui_homePage_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(170, 210, 771, 311))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_8.setText(
            _translate("MainWindow", "技术栈：pyqt5+mysql+python3+卷积神经网络CNN+opencv2+YOLO+tensorflow"))
        ...
        self.label_10.setText(
            _translate("MainWindow", "app-content:March口罩人脸识别系统，可应用于面向打卡、签到等多种领域"))
        ...
        self.app_button.setText(_translate("MainWindow", "程序信息"))
